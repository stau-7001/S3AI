...
class RegFocalLoss(_Loss):
    ...
    def __init__(self, size_average=None, reduce=None, gamma: int = 1, reduction: str = 'mean') -> None:
...
class ClsFocalLoss(_Loss):
    ...
    def __init__(self, size_average=None, reduce=None, reduction: str = 'mean', gamma: int = 1, alpha: float = 0.5) -> None:
