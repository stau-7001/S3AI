...
class onehotIC50Trainer(Trainer):
    def __init__(self, model, args, metrics: Dict[str, Callable], main_metric: str,
        ...
        super(onehotIC50Trainer, self).__init__(model, args, metrics, main_metric, device, tensorboard_functions,
...
#         print(Ab_ft.shape)
        reg_pred, cls_pred= self.model(Ab_ft.to(self.device),Ag_ft.to(self.device))  # forward the sequence to the model
